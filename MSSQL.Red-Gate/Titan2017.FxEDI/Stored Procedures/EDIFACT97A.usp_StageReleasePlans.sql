...
create procedure [EDIFACT97A].[usp_StageReleasePlans]
...
begin
	...
	begin try
		...
		if	@Debug & 0x01 = 0x01 begin
			...
			where
				xtpsd.StagingProcedureSchema = @StagingProcedureSchema
		...
		begin
			...
			,	DocumentDT =
					case Data.value('(/TRN-DELFOR/SEG-DTM/CE/DE[.="137"][@code="2005"]/../DE[@code="2379"])[1]', 'varchar(15)')
						when '102' Then FXSYS.udf_GetDT('CCYYMMDD', Data.value('(/TRN-DELFOR/SEG-DTM/CE/DE[.="137"][@code="2005"]/../DE[@code="2380"])[1]', 'varchar(15)'))
						when '103' Then FXSYS.udf_GetDT('CCYYWW', Data.value('(/TRN-DELFOR/SEG-DTM/CE/DE[.="137"][@code="2005"]/../DE[@code="2380"])[1]', 'varchar(15)'))
						when '203' Then FXSYS.udf_GetDT('CCYYMMDDHHMM', Data.value('(/TRN-DELFOR/SEG-DTM/CE/DE[.="137"][@code="2005"]/../DE[@code="2380"])[1]', 'varchar(15)'))
						else Data.value('(/TRN-DELFOR/SEG-DTM/CE/DE[.="137"][@code="2005"]/../DE[@code="2380"])[1]', 'varchar(15)')
					end
			from
		...
		begin
			...
			from
				@ReleasePlans rp
				outer apply rp.Data.nodes('/LOOP-LIN/SEG-LOC') as SEG_LOC(Data)
		...
		begin
			...
			,	ReceivedAccumBeginDT = LOOP_QTY_CUM.Data.value('(SEG-DTM/CE/DE[.="51"][@code="2005"]/../DE[@code="2380"])[1]', 'varchar(50)')
			,	ReceivedAccumEndDT = LOOP_QTY_CUM.Data.value('(SEG-DTM/CE/DE[.="52"][@code="2005"]/../DE[@code="2380"])[1]', 'varchar(50)')
			,	ReceivedAccumEndDTQualifier = LOOP_QTY_CUM.Data.value('(SEG-DTM/CE/DE[.="52"][@code="2005"]/../DE[@code="2379"])[1]', 'varchar(50)')
			,	ReceivedQty = LOOP_QTY_LASTQTY.Data.value('(SEG-QTY/CE/DE[@code="6060"])[1]', 'varchar(50)')
			,	ReceivedQtyDT = LOOP_QTY_LASTQTY.Data.value('(SEG-DTM/CE/DE[@code="2380"])[1]', 'varchar(50)')
			,	ReceivedQtyDTQualifier = LOOP_QTY_LASTQTY.Data.value('(SEG-DTM/CE/DE[.="52"][@code="2005"]/../DE[@code="2379"])[1]', 'varchar(50)')
			,	ReceivedShipper = null
			--,	LOOP_RFF.Data.query('.')
			--,	LOOP_QTY_CUM.Data.query('.')
			from
				@ReleasePlans rp
				outer apply rp.Data.nodes('/LOOP-LIN/LOOP-RFF[CE/DE[.="AAK"][@code=1153]]') as LOOP_RFF(Data)
		...
		begin
			...
			,	AuthAccumEndDT = null
			,	AuthAccumEndDTQualifier = null
			,	FabAccum = LOOP_SCC_FAB.Data.value('(LOOP-QTY/SEG-QTY/CE/DE[@code=6060])[1]', 'varchar(50)')
			,	FabAccumBeginDT = LOOP_SCC_FAB.Data.value('(LOOP-QTY/SEG-DTM/CE/DE[.="51"][@code="2005"]/../DE[@code="2380"])[1]', 'varchar(50)')
			,	FabAccumEndDT = LOOP_SCC_FAB.Data.value('(LOOP-QTY/SEG-DTM/CE/DE[.="52"][@code="2005"]/../DE[@code="2380"])[1]', 'varchar(50)')
			,	RawAccum = LOOP_SCC_RAW.Data.value('(LOOP-QTY/SEG-QTY/CE/DE[@code=6060])[1]', 'varchar(50)')
			,	RawAccumBeginDT = LOOP_SCC_RAW.Data.value('(LOOP-QTY/SEG-DTM/CE/DE[.="51"][@code="2005"]/../DE[@code="2380"])[1]', 'varchar(50)')
			,	RawAccumEndDT = LOOP_SCC_RAW.Data.value('(LOOP-QTY/SEG-DTM/CE/DE[.="52"][@code="2005"]/../DE[@code="2380"])[1]', 'varchar(50)')
			--,	LOOP_SCC_FAB.Data.query('.')
			--,	LOOP_SCC_RAW.Data.query('.')
			from
				@ReleasePlans rp
				cross apply rp.Data.nodes('/LOOP-LIN/LOOP-SCC[SEG-SCC/DE[.="2"][@code="4017"]]') as LOOP_SCC_FAB(Data)
				cross apply rp.Data.nodes('/LOOP-LIN/LOOP-SCC[SEG-SCC/DE[.="3"][@code="4017"]]') as LOOP_SCC_RAW(Data)
		...
		begin
			...
			from
				@ReleasePlans rp
				cross apply rp.Data.nodes('/LOOP-LIN/LOOP-SCC[SEG-SCC/DE[.="1" or .="4"][@code="4017"]]/LOOP-QTY[SEG-QTY/CE/DE[.="1"][@code="6063"]]') as LOOP_QTY(Data)
		...
		begin
			...
			if	@Debug & 0x01 = 0x01 begin
				select 'EDIFACT97A.ReleasePlanHeaders', * from EDIFACT97A.ReleasePlanHeaders rph
			end

			insert
				EDIFACT97A.ReleasePlanSupplemental
			(	RawDocumentGUID
			,	ReleaseNo
			,	ShipToCode
			,	ConsigneeCode
			...
			if	@Debug & 0x01 = 0x01 begin
				select 'EDIFACT97A.ReleasePlanSupplemental', * from EDIFACT97A.ReleasePlanSupplemental rps
			end

			insert
				EDIFACT97A.ReleasePlanAccums
			(	RawDocumentGUID
			,	ReleaseNo
			,	ShipToCode
			,	ConsigneeCode
			...
			if	@Debug & 0x01 = 0x01 begin
				select 'EDIFACT97A.ReleasePlanAccums', * from EDIFACT97A.ReleasePlanAccums rpa
			end

			insert
				EDIFACT97A.ReleasePlanAuthAccums
			(	RawDocumentGUID
			,	ReleaseNo
			,	ShipToCode
			,	ConsigneeCode
			...
			if	@Debug & 0x01 = 0x01 begin
				select 'EDIFACT97A.ReleasePlanAuthAccums', * from EDIFACT97A.ReleasePlanAuthAccums rpaa
			end

			insert
				EDIFACT97A.ReleasePlanReleases
			(	RawDocumentGUID
			,	ReleaseNo
			,	ShipToCode
			,	ConsigneeCode
			...
			if	@Debug & 0x01 = 0x01 begin
				select 'EDIFACT97A.ReleasePlanReleases', * from EDIFACT97A.ReleasePlanReleases rpr
			end
...
execute
	@ProcReturn = EDIFACT97A.usp_StageReleasePlans
	@TranDT = @TranDT out
