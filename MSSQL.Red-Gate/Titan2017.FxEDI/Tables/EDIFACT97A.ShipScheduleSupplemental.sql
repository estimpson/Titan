CREATE TABLE [EDIFACT97A].[ShipScheduleSupplemental]
(
[Status] [int] NOT NULL CONSTRAINT [DF__ShipSched__Statu__36BC0F3B] DEFAULT ((0)),
[Type] [int] NOT NULL CONSTRAINT [DF__ShipSchedu__Type__37B03374] DEFAULT ((0)),
...
[RowCreateDT] [datetime] NULL CONSTRAINT [DF__ShipSched__RowCr__38A457AD] DEFAULT (getdate()),
[RowCreateUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ShipSched__RowCr__39987BE6] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__ShipSched__RowMo__3A8CA01F] DEFAULT (getdate()),
[RowModifiedUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ShipSched__RowMo__3B80C458] DEFAULT (suser_name())
) ON [PRIMARY]
GO
...
create trigger [EDIFACT97A].[tr_ShipScheduleSupplemental_uRowModified] on [EDIFACT97A].[ShipScheduleSupplemental] after update
as
declare
	@TranDT datetime
,	@Result int
...
begin try
	...
	if	not update(RowModifiedDT) begin
		--- <Update rows="*">
		set	@TableName = 'EDIFACT97A.ShipScheduleSupplemental'
		...
		from
			EDIFACT97A.ShipScheduleSupplemental sss
			join inserted i
...
*/
GO
ALTER TABLE [EDIFACT97A].[ShipScheduleSupplemental] ADD CONSTRAINT [PK__ShipSche__FFEE7451EFD2C061] PRIMARY KEY CLUSTERED  ([RowID]) ON [PRIMARY]
GO
