...
(
[Status] [int] NOT NULL CONSTRAINT [DF__ReleasePl__Statu__03DB89B3] DEFAULT ((0)),
[Type] [int] NOT NULL CONSTRAINT [DF__ReleasePla__Type__04CFADEC] DEFAULT ((0)),
...
[RowCreateDT] [datetime] NULL CONSTRAINT [DF__ReleasePl__RowCr__05C3D225] DEFAULT (getdate()),
[RowCreateUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ReleasePl__RowCr__06B7F65E] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__ReleasePl__RowMo__07AC1A97] DEFAULT (getdate()),
[RowModifiedUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ReleasePl__RowMo__08A03ED0] DEFAULT (suser_name())
) ON [PRIMARY]
GO
...
*/
GO
ALTER TABLE [EDI3060].[ReleasePlanSupplemental] ADD CONSTRAINT [PK__ReleaseP__FFEE7451FE3AC570] PRIMARY KEY CLUSTERED  ([RowID]) ON [PRIMARY]
GO
