...
(
[Status] [int] NOT NULL CONSTRAINT [DF__ShipSched__Statu__0E8E2250] DEFAULT ((0)),
[Type] [int] NOT NULL CONSTRAINT [DF__ShipSchedu__Type__0F824689] DEFAULT ((0)),
...
[RowCreateDT] [datetime] NULL CONSTRAINT [DF__ShipSched__RowCr__10766AC2] DEFAULT (getdate()),
[RowCreateUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ShipSched__RowCr__116A8EFB] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__ShipSched__RowMo__125EB334] DEFAULT (getdate()),
[RowModifiedUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ShipSched__RowMo__1352D76D] DEFAULT (suser_name())
) ON [PRIMARY]
GO
...
create trigger [EDI4010].[tr_ShipScheduleSupplemental_uRowModified] on [EDI4010].[ShipScheduleSupplemental] after update
as
declare
	@TranDT datetime
,	@Result int
...
*/
GO
ALTER TABLE [EDI4010].[ShipScheduleSupplemental] ADD CONSTRAINT [PK__ShipSche__FFEE74514AB00026] PRIMARY KEY CLUSTERED  ([RowID]) ON [PRIMARY]
GO
