CREATE TABLE [dbo].[order_detail_copy]
(
...
GO
ALTER TABLE [dbo].[order_detail_copy] ADD CONSTRAINT [PK__order_detail_cop__3A179ED3] PRIMARY KEY CLUSTERED  ([id]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
