...
BEGIN TRANSACTION
insert  #DELJITSchedule(            customerpart    ,
                            destination        ,
                            customerPO        ,
                            modelYear            ,
                            ReleaseNumber    ,
    ...
    select     rtrim(edi_CAMIDELJIT_Detail.CAMIPart) as custpart,
            ...
            RTRIM(edi_CAMIDELJIT_Detail.ModelYear),
            rtrim(isNull((CASE WHEN rtrim(PlanStatusInd)='1' THEN edi_CAMIDELJIT_Detail.CAMIOrderNo ELSE '' END),''))+'*'+rtrim(edi_CAMIDELJIT_Detail.Relno),
            'N',
