...
CREATE PROCEDURE [dbo].[msp_adjust_planning_862_benteler]
AS
begin TRANSACTION

--2018-11-27 ASB FT,LLC - Created for sole purpose of isolating benteler ship schedule processing

delete	order_detail
from	order_detail
	join order_header on order_detail.order_no = order_header.order_no
	join m_in_ship_schedule_benteler on 
	order_header.customer_part = m_in_ship_schedule_benteler.customer_part and
	order_header.destination = m_in_ship_schedule_benteler.shipto_id
