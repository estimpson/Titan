...
CREATE PROCEDURE [dbo].[msp_adjust_planning_830_modatek]
AS
begin TRANSACTION

--03/16/2019 ASB FT, LLC - Created copy for sole purpose of isolating Modatek release processing

delete	order_detail
from	order_detail
	join order_header on order_detail.order_no = order_header.order_no
	join m_in_release_plan_modatek on 
	order_header.customer_part = m_in_release_plan_modatek.customer_part and
	order_header.destination = m_in_release_plan_modatek.shipto_id
