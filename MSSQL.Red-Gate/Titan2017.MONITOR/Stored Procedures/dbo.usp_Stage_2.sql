...
Create procedure [dbo].[usp_Stage_2]
...
execute
	...
	@objname = N'dbo.StagingShipScheduleHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'dbo.StagingShipScheduleSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'dbo.StagingShipScheduleAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'dbo.StagingShipScheduleAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'dbo.StagingShipSchedules'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'dbo.StagingPlanningHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'dbo.StagingPlanningSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'dbo.StagingPlanningAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'dbo.StagingPlanningAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'dbo.StagingPlanningReleases'
...
,	sfh.DocumentDT
from
	dbo.StagingShipScheduleHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'dbo.ShipScheduleSupplemental'

insert
	dbo.ShipScheduleSupplemental
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	dbo.StagingshipScheduleSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'dbo.ShipScheduleAccums'

insert
	dbo.ShipScheduleAccums
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	dbo.StagingshipScheduleAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'dbo.ShipScheduleAuthAccums'

insert
	dbo.ShipScheduleAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	dbo.StagingShipScheduleAuthAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'dbo.ShipSchedules'
...
,	sfh.DocumentDT
from
	dbo.StagingPlanningHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'dbo.PlanningSupplemental'

insert
	dbo.PlanningSupplemental
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	dbo.StagingPlanningSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'dbo.PlanningAccums'
...
from
	dbo.StagingPlanningAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'dbo.PlanningAuthAccums'

insert
	dbo.PlanningAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	dbo.StagingPlanningAuthAccumsT 
...
select
      ...
      ,[DateDT]
from
	dbo.StagingPlanningReleasesT sfr
...
truncate table
	dbo.StagingShipScheduleHeadersT
truncate table
	dbo.StagingShipScheduleSupplementalT
truncate table
	dbo.StagingShipScheduleAccumsT
truncate table
	dbo.StagingShipScheduleAuthAccumsT
truncate table
	dbo.StagingShipSchedulesT
truncate table
	dbo.StagingPlanningHeadersT
truncate table
	dbo.StagingPlanningSupplementalT
truncate table
	dbo.StagingPlanningAccumsT
truncate table
	dbo.StagingPlanningAuthAccumsT
truncate table
	dbo.StagingPlanningReleasesT
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'dbo.StagingShipScheduleHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'dbo.StagingShipScheduleSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'dbo.StagingShipScheduleAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'dbo.StagingShipScheduleAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'dbo.StagingShipSchedulesT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'dbo.StagingPlanningHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'dbo.StagingPlanningSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'dbo.StagingPlanningAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'dbo.StagingPlanningAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'dbo.StagingPlanningReleasesT'
...
select
	*
from
	dbo.ShipScheduleSupplemental sdrv

Select 'SSAccums'	
select
	*
from
	dbo.ShipScheduleAccums sdrv

Select 'SSAuthAccums'
select
	*
from
	dbo.ShipScheduleAuthAccums sdrv

Select 'SSchedules'
select
	*
from
	dbo.ShipSchedules sdrv
...
select
	*
from
	dbo.PlanningHeaders sdhv
Select 'PlanningSupplemental'
select
	*
from
	dbo.PlanningSupplemental sdrv
Select 'PlanningAccums'
select
	*
from
	dbo.PlanningAccums sdrv

Select 'PlanningAuthAccums'
select
	*
from
	dbo.PlanningAuthAccums sdrv

Select 'PlanningReleases'
select
	*
from
	dbo.PlanningReleases sdrv
go
