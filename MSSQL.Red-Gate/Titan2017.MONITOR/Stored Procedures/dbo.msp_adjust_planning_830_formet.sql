...
CREATE PROCEDURE [dbo].[msp_adjust_planning_830_formet]
AS
begin TRANSACTION

--11/27/2018 ASB FT, LLC - Created copy for sole purpose of isolating Formet release processing

delete	order_detail
from	order_detail
	join order_header on order_detail.order_no = order_header.order_no
	join m_in_release_plan_formet on 
	order_header.customer_part = m_in_release_plan_formet.customer_part and
	order_header.destination = m_in_release_plan_formet.shipto_id
