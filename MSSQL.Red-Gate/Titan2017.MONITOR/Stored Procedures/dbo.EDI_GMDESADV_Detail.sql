...
--dbo.EDI_GMDESADV_Detail 290389, 47297
...
Select	CONVERT( char(80), '') AS PartialComplete,
	...
	INSERT	#DESADVFlatFileLines (LineData)
	select	('04'+ LEFT(IDType92,2)+ LEFT(MaterialIssuer,9) + LEFT(IDType92,2)+ + LEFT(Destination,9) + LEFT(ShippingDock,25) + LEFT(Qual16,2)+ + LEFT(SupplierCode,9) ) from #DESADVHeaderRaw
	INSERT	#DESADVFlatFileLines (LineData)
