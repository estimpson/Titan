...
/*
Create Procedure.FxDependencies.EDI.usp_XMLShipNotice_GetShipNoticeXML.sql
*/
...
begin
	...
	begin try
		...
		begin
			...
			'
			,	@VarcharXMLOutput nvarchar(max)

			execute
				sys.sp_executesql
				@stmt = @Statement
			,	@parameters = N'@XMLOutput nvarchar(max) output'
			,	@VarcharXMLOutput = @VarcharXMLOutput out

			set @XMLOutput = convert(xml, @VarcharXMLOutput)
