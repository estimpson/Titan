------------------------------------------------------------
-- filename:	monitor4_upgrade_sqlany
-- purpose:	convert a 3.3h to 4.0 database to the latest
--		version of 4.0 for sybase sql anywhere 5.x
------------------------------------------------------------
print '
----------------
-- Table Changes
...
where	isnull(oh.status,'O') = 'O' and
	...
	od.release_no > ''
group by od.order_no, od.part_number, due, od.release_no, od.quantity, od.committed_qty
go
...
create view cdivw_getreleaseno (	
	...
	release_no)
as
select	od.order_no, od.part_number, convert(varchar(10), od.due_date, 110) due, min(od.release_no)
from	order_detail od
	join order_header oh on oh.order_no = od.order_no
where	od.committed_qty < od.quantity and 
	od.release_no > ''
group by od.order_no, od.part_number, due
go

print '
----------------------------------
--	Procedure: cdisp_gssreport
----------------------------------
'
...
begin 	
	...
	begin
		...
		from	#ordtemp
			cross join parameters
		where	dpdue <> 0 or dday1 <> 0 or dday2 <> 0 or dday3 <> 0 or
					 dday4 <> 0 or dday5 <> 0 or dday6 <> 0
		order	by 1, 2, 4
	end
	else
	begin
...
print '
----------------------------------
--	Trigger: cditr_pohistory_u
----------------------------------
'
--	Dropping some trigger which was created earlier 
if exists ( select 1 from sysobjects where name = 'mtr_po_detail_trail_u')
	drop trigger mtr_po_detail_trail_u
go
--	Dropping the new trigger	
if exists ( select 1 from sysobjects where name = 'cditr_pohistory_u')
	drop trigger cditr_pohistory_u
go
--	Creating the new update trigger on po detail 	
create trigger cditr_pohistory_u after update of received, quantity
order 2 on po_detail
referencing old as old_record new as new_record
for each row
begin
	if new_record.quantity > 0 and update(quantity) and update(received) then
		insert into cdipohistory 
			...
			release_no)
		values	(new_record.po_number, new_record.vendor_code, 	new_record.part_number, 
			new_record.unit_of_measure, new_record.date_due, new_record.type, 
			GetDate(*), (new_record.received-old_record.received), 
			new_record.quantity, new_record.received, new_record.balance,
			new_record.price, new_record.row_id, new_record.release_no)
	end if
end
go
...
---------------------------
'
if not exists (select 1 from dbo.syscolumns, dbo.sysobjects where dbo.sysobjects.id = dbo.syscolumns.id and dbo.sysobjects.name = 'part_vendor' and dbo.syscolumns.name = 'note')
	alter table part_vendor add note text null
go

print '
------------------------------
--	view: cdivw_blanket_po
------------------------------
'
...
-----------------------------------------
'
if not exists (select 1 from dbo.syscolumns, dbo.sysobjects where dbo.sysobjects.id = dbo.syscolumns.id and dbo.sysobjects.name = 'vendor' and dbo.syscolumns.name = 'status')
	alter table vendor add status varchar(20) null
go

print'
----------------------------------------------------
--	Update existing vendors with Approved status
----------------------------------------------------
'
...
--------------------------------------------------
'
if not exists (select 1 from sysobjects where name = 'vendor_service_status')
begin
	CREATE TABLE vendor_service_status (
		status_name varchar (20) NOT NULL ,
		status_type varchar (1) NOT NULL ,
		default_value varchar (1) NOT NULL ,
		CONSTRAINT PK__vendor_service__27C3E46E PRIMARY KEY  CLUSTERED 
		(
			status_name
		)
	)
...
-----------------------------
'
if not exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'admin' and sc.id = so.id and sc.name = 'db_invoice_sync' )
	alter table admin add db_invoice_sync char(1) null
go

if not exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'admin' and sc.id = so.id and sc.name = 'db_invoice_sync' )
	alter table admin rename admin_temp
go
...
--------------------------
'
if not exists ( select 1 from dbo.syscolumns sc,dbo.sysobjects so where so.name = 'activity_router' and sc.id = so.id and sc.name = 'labor' and sc.length = 25 )
	alter table activity_router modify labor varchar(25) null
go
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'activity_router' and sc.id = so.id and sc.name = 'time_stamp' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table activity_router modify time_stamp datetime
go
...
----------------------------
'
if ( select count(1) from syscolumns where tname = 'alternative_parts' and in_primary_key = 'Y' ) > 0
	alter table alternative_parts drop primary key
go
if not exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'alternative_parts' and sc.id = so.id and sc.name = 'main_part' and st.usertype = sc.usertype and st.name = 'varchar' )
	alter table alternative_parts modify main_part varchar(25) not null
go
if not exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'alternative_parts' and sc.id = so.id and sc.name = 'alt_part' and st.usertype = sc.usertype and st.name = 'varchar' )
	alter table alternative_parts modify alt_part varchar(25) not null
go
...
----------------------
'
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'audit_trail' and sc.id = so.id and sc.name = 'date_stamp' and st.usertype = sc.usertype and st.name = 'timestamp' )
begin
	if ( select count ( cname ) from syscolumns where tname = 'audit_trail' and in_primary_key = 'Y' ) > 0
		alter table audit_trail drop primary key
		
	alter table audit_trail modify date_stamp datetime
	
	alter table audit_trail add primary key ( serial, date_stamp )
end
go
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'audit_trail' and sc.id = so.id and sc.name = 'due_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table audit_trail modify due_date datetime
go
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'audit_trail' and sc.id = so.id and sc.name = 'start_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table audit_trail modify start_date datetime
go
...
go
if not exists ( select 1 from sys.sysindexes where tname = 'audit_trail' and colnames = 'shipper asc' )
	CREATE  INDEX audit_trail_shipper_ix ON audit_trail(shipper)
go
if not exists ( select 1 from sys.sysindexes where tname = 'audit_trail' and colnames like '%workorder%' and colnames like '%type%' )
	CREATE  INDEX audit_trail_workorder_type_ix ON audit_trail(workorder, type)
go
if not exists ( select 1 from sys.sysindexes where tname = 'audit_trail' and colnames like '%date_stamp%' and colnames like '%type%' )
	CREATE  INDEX date_type ON audit_trail(date_stamp, type)
go
if not exists ( select 1 from sys.sysindexes where tname = 'audit_trail' and colnames like '%part%' and colnames like '%type%' and colnames like '%to_loc%' )
	CREATE  INDEX part_type_to ON audit_trail(part, type, to_loc)
go
if not exists ( select 1 from sys.sysindexes where tname = 'audit_trail' and colnames like '%posted%' and colnames like '%type%' )
	CREATE  INDEX type_for_objhist_u ON audit_trail(type, posted)
go
...
-------------------------
'
if not exists ( select 1 from dbo.syscolumns sc,dbo.sysobjects so where so.name = 'bill_of_lading' and sc.id = so.id and sc.name = 'destination' and sc.length = 20 )
	alter table bill_of_lading modify destination varchar (20) NULL
go
if not exists ( select 1 from dbo.syscolumns sc,dbo.sysobjects so where so.name = 'bill_of_lading' and sc.id = so.id and sc.name = 'scac_transfer' and sc.length = 35 )
	alter table bill_of_lading modify scac_transfer varchar (35) NULL
go
if not exists ( select 1 from dbo.syscolumns sc,dbo.sysobjects so where so.name = 'bill_of_lading' and sc.id = so.id and sc.name = 'scac_pickup' and sc.length = 35 )
	alter table bill_of_lading modify scac_pickup varchar (35) NULL
go
...
else if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'bill_of_material_ec' and sc.id = so.id and sc.name = 'start_datetime' and st.usertype = sc.usertype and st.name = 'timestamp' )
begin
	if ( select count ( cname ) from syscolumns where tname = 'bill_of_material_ec' and in_primary_key = 'Y' ) > 0
		alter table bill_of_material_ec drop primary key
		
	alter table bill_of_material_ec modify start_datetime datetime
	
	alter table bill_of_material_ec add primary key ( parent_part, part, start_datetime )
end
else if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'bill_of_material_ec' and sc.id = so.id and sc.name = 'end_datetime' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table bill_of_material_ec modify end_datetime datetime
else if exists ( select 1 from syscolumns where tname = 'bill_of_material_ec' and cname = 'date_changed' and nulls = 'Y')
	alter table bill_of_material_ec modify date_changed datetime not null
go
...
---------------------------------------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id('mvw_billofmaterial') )
...
------------------
'
if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'contact' and sc.id = so.id and sc.name = 'address_1' )
	alter table contact delete address_1
go
if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'contact' and sc.id = so.id and sc.name = 'address_2' )
	alter table contact delete address_2
go
if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'contact' and sc.id = so.id and sc.name = 'address_3' )
	alter table contact delete address_3
go
if not exists ( select 1 from dbo.syscolumns sc,dbo.sysobjects so where so.name = 'contacts' and sc.id = so.id and sc.name = 'phone' and sc.length = 20 )
	alter table contact modify phone varchar(20)
go
...
---------------------------
'
if not exists ( select 1 from dbo.sysobjects where name = 'contact_call_log' )
begin
...
begin
	if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'contact_call_log' and sc.id = so.id and sc.name = 'start_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	begin
		if ( select count ( cname ) from syscolumns where tname = 'contact_call_log' and in_primary_key = 'Y' ) > 0
			alter table contact_call_log drop primary key
			
		alter table contact_call_log modify start_date datetime
	end

	if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'contact_call_log' and sc.id = so.id and sc.name = 'stop_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
		alter table contact_call_log modify stop_date datetime
end
go
...
begin
	if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'currency_conversion' and sc.id = so.id and sc.name = 'effective_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	begin
		if ( select count(*) from syscolumns where tname = 'currency_conversion' and in_primary_key = 'Y' ) > 0
			alter table currency_conversion drop primary key
		alter table currency_conversion modify effective_date datetime
		alter table currency_conversion add primary key ( currency_code, effective_date )
	end
end
go
...
if exists ( select 1 from dbo.sysobjects where name = 'custom_pbl_link' )
	alter table custom_pbl_link rename custom_pbl_link_temp
go
...
-------------------      
'
if not exists ( select 1 from dbo.syscolumns sc,dbo.sysobjects so where so.name = 'customer' and sc.id = so.id and sc.name = 'phone' and sc.length = 20 )
	alter table customer modify phone varchar(20) null
go
if not exists ( select 1 from dbo.syscolumns sc,dbo.sysobjects so where so.name = 'customer' and sc.id = so.id and sc.name = 'modem' and sc.length = 20 )
	alter table customer modify modem varchar(20) null
go
if not exists ( select 1 from dbo.syscolumns sc,dbo.sysobjects so where so.name = 'customer' and sc.id = so.id and sc.name = 'fax' and sc.length = 20 )
	alter table customer modify fax varchar(20) null
go
...
else if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'customer' and sc.id = so.id and sc.name = 'create_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table customer modify create_date datetime
go
...
if exists ( select 1 from dbo.sysobjects where name = 'defects' )
	alter table defects rename defects_temp
go
...
-----------------------
'
if not exists ( select 1 from dbo.sysobjects where name = 'dim_relation' )
begin
...
---------------------
'
if not exists ( select 1 from dbo.sysobjects where name = 'dimensions' )
begin
...
print'
-----------------------
-- down_pointer changes
-----------------------
'
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'down_pointer' and sc.id = so.id and sc.name = 'time_stamp' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table down_pointer modify time_stamp datetime
go
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'down_pointer' and sc.id = so.id and sc.name = 'date_stamp' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table down_pointer modify date_stamp datetime
go
...
if exists ( select 1 from dbo.sysobjects where name = 'downtime' )
	alter table downtime rename downtime_temp
go
...
-------------------------
'
alter table downtime_codes modify code_group null
go
...
if not exists ( select 1 from dw_inquiry_files where datawindow_name = 'd_unprinted_invoices' )
	insert into dw_inquiry_files values ('d_unprinted_invoices','Invoice Inquiry','shipper','invoice_number','Y',NULL,'w_invoice_detail','N',
		1,'N','N','Y','Y',NULL,'SHIPPER','N',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Y',NULL,'Y','w_invoice_detail',NULL,NULL,'Y','N',NULL)
go
if not exists ( select 1 from dw_inquiry_files where datawindow_name = 'd_po_inquiry' )
	...
	values ('d_po_inquiry','PO Inquiry','po_header','po_number','Y',NULL,'w_po_inquiry','N',
		1,'N','N','Y','Y',NULL,'PO_HEADER','N',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Y',NULL,'Y','w_po_inquiry',NULL,NULL,'Y','N',NULL)
go
...
------------------------
'
if not exists ( select 1 from dbo.sysobjects where name = 'edi_ff_layout' )
begin
...
else if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'edi_ff_layout' and sc.id = so.id and sc.name = 'version_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table edi_ff_layout modify version_date datetime
go
...
-----------------------
'
if not exists ( select 1 from dbo.sysobjects where name = 'edi_ff_loops' )
begin
...
----------------------------------
'
if ( select count(1) from sys.syscolumns where tname = 'effective_change_notice' and in_primary_key = 'Y' ) > 0
	alter table effective_change_notice drop primary key
go
if not exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'effective_change_notice' and sc.id = so.id and sc.name = 'operator' )
	alter table effective_change_notice add operator varchar(5) not null
go
if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'effective_change_notice' and sc.id = so.id and sc.name = 'sequence' )
	alter table effective_change_notice delete sequence
go
if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'effective_change_notice' and sc.id = so.id and sc.name = 'who' )
	alter table effective_change_notice delete who
go
if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'effective_change_notice' and sc.id = so.id and sc.name = 'time_stamp' )
	alter table effective_change_notice delete time_stamp
go
alter table effective_change_notice modify effective_date datetime not null
go
begin
	...
	declare duplicates cursor for 
		...
		where	( select count(1) from effective_change_notice ecn2 where ecn2.part = ecn1.part and ecn2.effective_date = ecn1.effective_date ) > 1
...
go
if ( select count ( cname ) from syscolumns where tname = 'effective_change_notice' and in_primary_key = 'Y' ) > 0
	alter table effective_change_notice drop primary key
go	
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'effective_change_notice' and sc.id = so.id and sc.name = 'effective_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table effective_change_notice modify effective_date datetime
go
...
if (	select	count(name)
	...
	RAISERROR 99999 'Please get rid of any duplicate operator_code values from the employee table and run the employee changes section again.'
else
begin
	if exists ( select 1 from dbo.sysobjects where name = 'employee' )
		alter table employee rename employee_temp
	...
	alter table employee add unique ( password )
end
go
...
if exists ( select 1 from dbo.sysobjects where name = 'exp_apdata_detail' )
	alter table exp_apdata_detail rename exp_apdata_detail_temp
go
...
if exists ( select 1 from dbo.sysobjects where name = 'exp_apdata_header' )
	alter table exp_apdata_header rename exp_apdata_header_temp
go
...
if not exists (select 1 from dbo.sysobjects where id = object_id('freight_type_definition'))
	create table freight_type_definition (
		type_name	varchar(20) not null primary key
			...
			from 	syscolumns
			where	tname = 'freight_type_definition' and 
				in_primary_key = 'Y' )
...
-----------------------
'
if not exists ( select 1 from dbo.sysobjects where name = 'gl_tran_type' ) 
begin
...
----------------------
'
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'gt_bom_info' and sc.id = so.id and sc.name = 'due_datetime' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table gt_bom_info modify due_datetime datetime
go
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'gt_bom_info' and sc.id = so.id and sc.name = 'dropdead_datetime' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table gt_bom_info modify dropdead_datetime datetime
go
...
if exists ( select 1 from dbo.sysobjects where name = 'inventory_accuracy_history' )
	alter table inventory_accuracy_history rename inventory_accuracy_history_tmp
go
...
begin
	if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'issues' and sc.id = so.id and sc.name = 'start_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
		alter table issues modify start_date datetime

	if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'issues' and sc.id = so.id and sc.name = 'stop_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
		alter table issues modify stop_date datetime
end
go
...
--------------
'
if not exists ( select 1 from dbo.sysobjects where name = 'log' )
	CREATE TABLE	log
	(	spid	integer	NOT NULL,
		id		integer	NOT NULL,
...
----------------------------
'
if not exists ( select 1 from dbo.sysobjects where name = 'machine_data_1050' )
begin
...
else if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'machine_data_1050' and sc.id = so.id and sc.name = 'last_reset' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table machine_data_1050 modify last_reset datetime
go
...
-------------------------
'
if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'machine_policy' and sc.id = so.id and sc.name = 'scale_com_port' )
	alter table machine_policy delete scale_com_port
go
if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'machine_policy' and sc.id = so.id and sc.name = 'scale_prompt_user' )
	alter table machine_policy delete scale_prompt_user
go
if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'machine_policy' and sc.id = so.id and sc.name = 'scale_type' )
	alter table machine_policy delete scale_type
go
if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'machine_policy' and sc.id = so.id and sc.name = 'scale_attached' )
	alter table machine_policy delete scale_attached
go

print'
---------------------------------------------------------------
--	Changes to master_prod_sched 
---------------------------------------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id('master_prod_sched') )
...
-----------------------------
'
IF Not Exists ( SELECT 1 FROM dbo.sysobjects WHERE name = 'm_in_ship_schedule' )
...
begin
	if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'm_in_ship_schedule' and sc.id = so.id and sc.name = 'release_dt' and st.usertype = sc.usertype and st.name = 'timestamp' )
		alter table m_in_ship_schedule modify release_dt datetime
end
GO
...
go
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'object' and sc.id = so.id and sc.name = 'last_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table object modify last_date datetime
go
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'object' and sc.id = so.id and sc.name = 'last_time' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table object modify last_time datetime
go
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'object' and sc.id = so.id and sc.name = 'date_due' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table object modify date_due datetime
go
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'object' and sc.id = so.id and sc.name = 'start_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table object modify start_date datetime
go
alter table object modify origin varchar(20)
go
if not exists ( select 1 from sys.sysindexes where tname = 'object' and colnames = 'shipper asc' )
	CREATE  INDEX ix_object_3 ON object(shipper)
go
if not exists ( select 1 from sys.sysindexes where tname = 'object' and colnames = 'part asc' )
	CREATE  INDEX part ON object(part)
go
if not exists ( select 1 from sys.sysindexes where tname = 'object' and colnames = 'status asc' )
...
begin
	...
	begin
 	...
 	alter table ole_objects rename ole_objects_temp
end
go
create table ole_objects
(
	id    varchar(255) not null,
	ole_object text null,
...
go
if exists ( select 1 from dbo.sysindexes where name = 'ole_objects_ui1' )
	drop index ole_objects_ui1
go
...
begin
	...
	select id, ole_object, parent_id, date_stamp, serial from ole_objects_temp
...
-----------------------
'
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'order_header' and sc.id = so.id and sc.name = 'order_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table order_header modify order_date datetime
go
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'order_header' and sc.id = so.id and sc.name = 'fab_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table order_header modify fab_date datetime
go
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'order_header' and sc.id = so.id and sc.name = 'raw_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table order_header modify raw_date datetime
go
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'order_header' and sc.id = so.id and sc.name = 'po_expiry_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table order_header modify po_expiry_date datetime
go
...
else if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'order_header' and sc.id = so.id and sc.name = 'due_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table order_header modify due_date datetime
go
...
begin
	...
	update order_header set alternate_price = price
end
go
...
go
if not exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'order_header' and sc.id = so.id and sc.name = 'box_label' and sc.length = 25 )
	alter table order_header modify box_label varchar(25)
go
if not exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'order_header' and sc.id = so.id and sc.name = 'pallet_label' and sc.length = 25 )
	alter table order_header modify pallet_label varchar(25)
go
...
where order_header.cs_status is null and
	css.default_value = 'Y'
go
if not exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'order_header' and sc.id = so.id and sc.name = 'line11' and sc.length = 35 )
	alter table order_header modify line11 varchar(35)
go
if not exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'order_header' and sc.id = so.id and sc.name = 'line12' and sc.length = 35 )
	alter table order_header modify line12 varchar(35)
go
if not exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'order_header' and sc.id = so.id and sc.name = 'line13' and sc.length = 35 )
	alter table order_header modify line13 varchar(35)
go

if not exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'order_header' and sc.id = so.id and sc.name = 'line14' and sc.length = 35 )
	alter table order_header modify line14 varchar(35)
go
if not exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'order_header' and sc.id = so.id and sc.name = 'line15' and sc.length = 35 )
	alter table order_header modify line15 varchar(35)
go
if not exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'order_header' and sc.id = so.id and sc.name = 'line16' and sc.length = 35 )
	alter table order_header modify line16 varchar(35)
go
if not exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'order_header' and sc.id = so.id and sc.name = 'line17' and sc.length = 35 )
	alter table order_header modify line17 varchar(35)
go
if not exists ( select 1 from sys.sysindexes where tname = 'order_header' and colnames = 'customer asc' )
	CREATE  INDEX order_header_customer_ix ON order_header(customer)
go
...
---------------------
'
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'parameters' and sc.id = so.id and sc.name = 'fiscal_year_begin' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table parameters modify fiscal_year_begin datetime
go
...
go
if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'parameters' and sc.id = so.id and sc.name = 'need_suffix' )
	alter table parameters delete need_suffix
go
...
begin
	...
	update	parameters
	set	next_workorder = isnull ( (select max ( convert ( integer , work_order ) ) from work_order ), 1)
end
go
update parameters set requisition = 'N'
where requisition is null
go
...
if not exists ( select 1 from dbo.syscolumns sc,dbo.sysobjects so where so.name = 'part' and sc.id = so.id and sc.name = 'name' and sc.length = 100 )
	alter table part modify name varchar(100) not null
go
...
else if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'part' and sc.id = so.id and sc.name = 'eng_effective_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table part modify eng_effective_date datetime
go
...
--------------------------------
'
if not exists ( select 1 from dbo.sysobjects where name = 'part_class_definition' )
begin
...
begin
	if not exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'part_customer_price_matrix' and sc.id = so.id and sc.name = 'alternate_price' )
		alter table part_customer_price_matrix add alternate_price decimal(20,6) null
	
	if ( select count(1) from syscolumns where tname = 'part_customer_price_matrix' and in_primary_key = 'Y' ) > 0
		alter table part_customer_price_matrix drop primary key
	
	alter table part_customer_price_matrix modify qty_break not null
	
	alter table part_customer_price_matrix add primary key ( part, customer, qty_break )
end
go
...
begin
	if exists ( select 1 from dbo.sysobjects where name = 'part_gl_account' )
		alter table part_gl_account rename part_gl_account_temp
...
------------------------
'
if not exists ( select 1 from dbo.sysobjects where name = 'part_location' )
begin
...
if not exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'part_machine' and sc.id = so.id and sc.name = 'labor_code' )
	alter table part_machine add labor_code           varchar(25) null
else if not exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'part_machine' and sc.id = so.id and sc.name = 'labor_code' and sc.length = 25 )
	alter table part_machine modify labor_code           varchar(25) null
go
...
begin
        ...
        declare duplicates cursor for 
        select number(*),part,sequence,machine 
        from part_machine
        ...
        open duplicates
        fetch duplicates into @number, @part, @sequence, @machine
        while ( @@sqlstatus = 0 )
        begin
                update part_machine
                set sequence = @number
                where part = @part and machine= @machine
                fetch duplicates into @number, @part, @sequence, @machine
        end
        close duplicates
end
go
if exists ( select 1 from sysindexes where iname = 'part_machine_ui1' )
	drop index part_machine_ui1
go
...
----------------------------
'
if not exists ( select 1 from dbo.sysobjects where name = 'part_machine_tool' )
begin
...
-----------------------
'
if not exists ( select 1 from dbo.sysobjects where name = 'part_tooling' )
begin
...
---------------------------------
'
if not exists ( select 1 from dbo.sysobjects where name = 'part_machine_tool_list' )
begin
...
-------------------------------
'
if not exists ( select 1 from dbo.sysobjects where name = 'part_type_definition' )
begin
...
if not exists ( select 1 from dbo.syscolumns sc,dbo.sysobjects so where so.name = 'part_vendor' and sc.id = so.id and sc.name = 'part_name' and sc.length = 100 )
	alter table part_vendor modify part_name varchar(100) null
go
...
else if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'part_vendor' and sc.id = so.id and sc.name = 'beginning_inventory_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table part_vendor modify beginning_inventory_date datetime
go
...
-------------------
'
if not exists ( select 1 from dbo.sysobjects where name = 'partlist' )
...
--------------------
'
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'po_header' and sc.id = so.id and sc.name = 'po_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table po_header modify po_date datetime
go
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'po_header' and sc.id = so.id and sc.name = 'date_due' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table po_header modify date_due datetime
go
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'po_header' and sc.id = so.id and sc.name = 'scheduled_time' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table po_header modify scheduled_time datetime
go
if not exists ( select 1 from dbo.syscolumns sc,dbo.sysobjects so where so.name = 'po_header' and sc.id = so.id and sc.name = 'description' and sc.length = 100 )
	alter table po_header modify description varchar(100) null
go
...
if not exists ( select	1 
		from 	dbo.syscolumns sc,
			dbo.sysobjects so 
		where 	so.name = 'po_header' and 
			sc.id = so.id and 
			sc.name = 'freight_type' and sc.length = 20 )
	alter table po_header modify freight_type varchar(20)
go
update	po_header
set	type = 'N'
where	type is null
...
print'
--------------------------
-- price_promotion changes
--------------------------
'
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'price_promotion' and sc.id = so.id and sc.name = 'start_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table price_promotion modify start_date datetime
go
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'price_promotion' and sc.id = so.id and sc.name = 'end_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table price_promotion modify end_date datetime
go
...
if exists ( select 1 from dbo.sysobjects where name = 'production_shift' )
	alter table production_shift rename production_shift_temp
go
...
-----------------------
'
if 	not exists ( select 1 from dbo.systypes st,dbo.sysobjects so, dbo.syscolumns sc where so.name = 'quote' and sc.id = so.id and sc.name = 'quote_number' and st.usertype = sc.usertype and st.name = 'integer' )
begin
--	if quote_number column data type is not integer, change it to integer
	alter table quote drop primary key
	alter table quote modify quote_number integer not null
	alter table quote add primary key ( quote_number )
end
go
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'quote' and sc.id = so.id and sc.name = 'quote_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table quote modify quote_date datetime
go
if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'quote' and sc.id = so.id and sc.name = 'sales_order' )
	alter table quote delete sales_order
go
...
else if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'quote' and sc.id = so.id and sc.name = 'expire_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table quote modify expire_date datetime
go
...
----------------------
'
if not exists ( select 1 from dbo.sysobjects where name = 'report_list' )
begin
...
------------------
'
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'shipper' and sc.id = so.id and sc.name = 'date_shipped' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table shipper modify date_shipped datetime
go

if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'shipper' and sc.id = so.id and sc.name = 'time_shipped' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table shipper modify time_shipped datetime
go

if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'shipper' and sc.id = so.id and sc.name = 'date_stamp' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table shipper modify date_stamp datetime
go
...
else if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'shipper' and sc.id = so.id and sc.name = 'scheduled_ship_time' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table shipper modify scheduled_ship_time datetime
go
...
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'shipper' and sc.id = so.id and sc.name = 'bill_of_lading_number' and st.usertype = sc.usertype and st.name = 'varchar' )
	alter table shipper modify bill_of_lading_number integer NULL
go

if not exists ( select 1 from dbo.syscolumns sc, dbo.sysobjects so where so.name = 'shipper' and sc.id = so.id and sc.name = 'bol_ship_to' )
	alter table shipper add bol_ship_to varchar(20) NULL
go

if not exists ( select 1 from dbo.syscolumns sc, dbo.sysobjects so where so.name = 'shipper' and sc.id = so.id and sc.name = 'bol_carrier' )
	alter table shipper add bol_carrier varchar(35) NULL
go
...
if not exists ( select 1 from sys.sysindexes where tname = 'shipper' and colnames = 'customer asc,date_shipped asc' )
	CREATE  INDEX bwa_shipper_cust_indx ON shipper(customer, date_shipped)
go
...
if exists (select 1 from dbo.sysobjects where name = 'shop_floor_calendar')
	alter table shop_floor_calendar rename shop_floor_calendar_t
GO
...
begin
	insert into shop_floor_calendar ( machine, begin_datetime, end_datetime, labor_code, crew_size ) select  machine, begin_datetime, end_datetime, labor_code, crew_size from shop_floor_calendar_t

	if @@error = 0
		drop table shop_floor_calendar_t
...
if exists ( select 1 from dbo.sysobjects where name = 'shop_floor_time_log' ) and
   not exists ( select 1 from dbo.sysobjects where name = 'shop_floor_time_log_temp' )
	alter table shop_floor_time_log rename shop_floor_time_log_temp
go
...
if exists ( select 1 from dbo.sysobjects where name = 'time_log' )
	alter table time_log rename time_log_temp
go
...
-------------------
'
if not exists ( select 1 from dbo.sysobjects where name = 'unit_sub' )
begin
...
if not exists ( select 1 from dbo.syscolumns sc,dbo.sysobjects so where so.name = 'vendor' and sc.id = so.id and sc.name = 'phone' and sc.length = 20 )
	alter table vendor modify phone varchar(20) null
go

if not exists ( select 1 from dbo.syscolumns sc,dbo.sysobjects so where so.name = 'vendor' and sc.id = so.id and sc.name = 'fax' and sc.length = 20 )
	alter table vendor modify fax varchar(20) null
go
...
------------------------
'
if not exists ( select 1 from dbo.sysobjects where name = 'vendor_custom' ) 
begin
...
else if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'customer_additional' and sc.id = so.id and sc.name = 'start_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table customer_additional modify start_date datetime
go
...
else if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'customer_additional' and sc.id = so.id and sc.name = 'end_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table customer_additional modify end_date datetime
go
...
else if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'issue_detail' and sc.id = so.id and sc.name = 'date_stamp' and st.usertype = sc.usertype and st.name = 'timestamp' )
begin
	if ( select count ( cname ) from syscolumns where tname = 'issue_detail' and in_primary_key = 'Y' ) > 0
		alter table issue_detail drop primary key
	
	alter table issue_detail modify date_stamp datetime
...
if exists ( select 1 from dbo.sysobjects where name = 'kanban' ) 
	alter table kanban rename kanban_temp
go
...
------------------------------
'
if not exists ( select 1 from dbo.sysobjects where name = 'machine_serial_comm' ) 
begin
...
-----------------------
'
if not exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.id = sc.id and so.name = 'order_detail' and sc.name = 'id' )
begin
	select * into #order_detail_temp from order_detail
	delete from order_detail
	
	alter table order_detail drop primary key
	alter table order_detail add id integer not null default autoincrement
	alter table order_detail add primary key ( id )
	
	insert into order_detail (	
		order_no,sequence,part_number,type,product_name,quantity,price,notes,assigned,shipped,
		...
		packaging_type,weight,custom01,custom02,custom03,dimension_qty_string,engineering_level,box_label,pallet_label,alternate_price )
...
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'order_detail' and sc.id = so.id and sc.name = 'due_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table order_detail modify due_date datetime
go
...
begin
	...
	update order_detail set alternate_price = price
end
go
...
else if not exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'order_detail' and sc.id = so.id and sc.name = 'box_label' and sc.length = 25 )
	alter table order_detail modify box_label varchar(25)
go
...
else if not exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'order_detail' and sc.id = so.id and sc.name = 'pallet_label' and sc.length = 25 )
	alter table order_detail modify pallet_label varchar(25)
go
...
where	oh.order_no = order_detail.order_no and
	oh.order_type = 'B'
go

if not exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'order_detail' and sc.id = so.id and sc.name = 'product_name' and sc.length = 100 )
	alter table order_detail modify product_name varchar(100) null
go

if not exists ( select 1 from sys.sysindexes where tname = 'order_detail' and colnames = 'destination asc,part_number asc' )
	CREATE  INDEX destination_part ON order_detail(destination, part_number)
go

if not exists ( select 1 from sys.sysindexes where tname = 'order_detail' and colnames = 'order_no asc,row_id asc' )
	CREATE  INDEX order_rowid ON order_detail(order_no, row_id)
go

if not exists ( select 1 from sys.sysindexes where tname = 'order_detail' and colnames = 'row_id asc' )
	CREATE  INDEX rowid ON order_detail(row_id)
go
...
------------------------------------
'
if not exists ( select 1 from dbo.sysobjects where name = 'part_class_type_cross_ref' ) 
begin
...
-------------------------
'
if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'part_packaging' and sc.id = so.id and sc.name = 'scale_interface' )
	alter table part_packaging delete scale_interface
go

if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'part_packaging' and sc.id = so.id and sc.name = 'type_of_trigger' )
	alter table part_packaging delete type_of_trigger
go

if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'part_packaging' and sc.id = so.id and sc.name = 'tolerance' )
	alter table part_packaging delete tolerance
go

if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'part_packaging' and sc.id = so.id and sc.name = 'trigger_weight' )
	alter table part_packaging delete trigger_weight
go

if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'part_packaging' and sc.id = so.id and sc.name = 'trigger_prints_label' )
	alter table part_packaging delete trigger_prints_label
go

if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'part_packaging' and sc.id = so.id and sc.name = 'user_input_trigger' )
	alter table part_packaging delete user_input_trigger
go

if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'part_packaging' and sc.id = so.id and sc.name = 'trigger_type' )
	alter table part_packaging delete trigger_type
go

if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'part_packaging' and sc.id = so.id and sc.name = 'threshold_percent' )
	alter table part_packaging delete threshold_percent
go

if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'part_packaging' and sc.id = so.id and sc.name = 'inactivity_weight' )
	alter table part_packaging delete inactivity_weight
go
...
if not exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'part_packaging' and sc.id = so.id and sc.name = 'label_format' and sc.length = 25 )
	alter table part_packaging modify label_format varchar (25)
go
...
------------------------
'
if not exists ( select 1 from dbo.sysobjects where name = 'part_revision' ) 
begin
...
else if exists ( select 1 from syscolumns where tname = 'part_revision' and cname = 'effective_datetime' and nulls = 'Y')
	alter table part_revision modify effective_datetime datetime not null
go
...
if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'part_standard' and sc.id = so.id and sc.name = 'std_cost' )
	alter table part_standard rename std_cost to qtd_cost
...
if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'part_standard' and sc.id = so.id and sc.name = 'std_material' )
	alter table part_standard rename std_material to qtd_material
...
if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'part_standard' and sc.id = so.id and sc.name = 'std_labor' )
	alter table part_standard rename std_labor to qtd_labor
...
if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'part_standard' and sc.id = so.id and sc.name = 'std_burden' )
	alter table part_standard rename std_burden to qtd_burden
...
if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'part_standard' and sc.id = so.id and sc.name = 'std_other' )
	alter table part_standard rename std_other to qtd_other
...
if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'part_standard' and sc.id = so.id and sc.name = 'std_cost_cum' )
	alter table part_standard rename std_cost_cum to qtd_cost_cum
...
if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'part_standard' and sc.id = so.id and sc.name = 'std_material_cum' )
	alter table part_standard rename std_material_cum to qtd_material_cum
...
if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'part_standard' and sc.id = so.id and sc.name = 'std_labor_cum' )
	alter table part_standard rename std_labor_cum to qtd_labor_cum
...
if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'part_standard' and sc.id = so.id and sc.name = 'std_burden_cum' )
	alter table part_standard rename std_burden_cum to qtd_burden_cum
...
if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'part_standard' and sc.id = so.id and sc.name = 'std_other_cum' )
	alter table part_standard rename std_other_cum to qtd_other_cum
...
else if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'part_standard' and sc.id = so.id and sc.name = 'cost_changed_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table part_standard modify cost_changed_date datetime
go
...
if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'part_standard' and sc.id = so.id and sc.name = 'std_changed_date' ) and
	...
	alter table part_standard rename std_changed_date to qtd_changed_date
else if exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'part_standard' and sc.id = so.id and sc.name = 'std_changed_date' ) and
	...
	alter table part_standard delete std_changed_date
...
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'part_standard' and sc.id = so.id and sc.name = 'qtd_changed_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table part_standard modify qtd_changed_date datetime
go
...
else if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'part_standard' and sc.id = so.id and sc.name = 'planned_changed_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table part_standard modify planned_changed_date datetime
go
...
else if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'part_standard' and sc.id = so.id and sc.name = 'frozen_changed_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table part_standard modify frozen_changed_date datetime
go      
...
if exists ( select 1 from dbo.sysobjects where name = 'part_vendor_price_matrix' )
	alter table part_vendor_price_matrix rename part_vendor_price_matrix_temp
go
...
where 	( select count(1) from part_vendor pv where pv.part = part_vendor_price_matrix.part and pv.vendor = part_vendor_price_matrix.vendor ) < 1
go
...
--------------------
'
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'po_detail' and sc.id = so.id and sc.name = 'date_due' and st.usertype = sc.usertype and st.name = 'timestamp' )
begin
	if ( select count ( cname ) from syscolumns where tname = 'po_detail' and in_primary_key = 'Y' ) > 0
		alter table po_detail drop primary key
	
	alter table po_detail modify date_due datetime
	
	alter table po_detail add primary key (po_number, part_number, date_due, row_id)
end
go

if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'po_detail' and sc.id = so.id and sc.name = 'last_recvd_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table po_detail modify last_recvd_date datetime
go

if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'po_detail' and sc.id = so.id and sc.name = 'invoice_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table po_detail modify invoice_date datetime
go

if not exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'po_detail' and sc.id = so.id and sc.name = 'description' and sc.length = 100 )
	alter table po_detail modify description varchar(100) null
go

if not exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'po_detail' and sc.id = so.id and sc.name = 'account_code' and sc.length = 50 )
	alter table po_detail modify account_code varchar(50) null
go
...
else if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'po_detail' and sc.id = so.id and sc.name = 'scheduled_time' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table po_detail modify scheduled_time datetime
go
...
begin
	...
	update po_detail set alternate_price = price
end
go
...
----------------------------
'
if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'po_detail_history' and sc.id = so.id and sc.name = 'date_due' and st.usertype = sc.usertype and st.name = 'timestamp' )
begin
	if ( select count ( cname ) from syscolumns where tname = 'po_detail_history' and in_primary_key = 'Y' ) > 0
		alter table po_detail_history drop primary key
	
	alter table po_detail_history modify date_due datetime
	
	alter table po_detail_history add primary key (po_number, part_number, date_due, row_id)
end
go

if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'po_detail_history' and sc.id = so.id and sc.name = 'last_recvd_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table po_detail_history modify last_recvd_date datetime
go

if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'po_detail_history' and sc.id = so.id and sc.name = 'invoice_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table po_detail_history modify invoice_date datetime
go

if not exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'po_detail_history' and sc.id = so.id and sc.name = 'description' and sc.length = 100 )
	alter table po_detail_history modify description varchar(100) null
go

if not exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'po_detail_history' and sc.id = so.id and sc.name = 'account_code' and sc.length = 50 )
	alter table po_detail_history modify account_code varchar(50) null
go
...
-----------------------
'
alter table quote_detail drop primary key
go

if exists ( select 1 from dbo.systypes st,dbo.sysobjects so, dbo.syscolumns sc where so.name = 'quote_detail' and sc.id = so.id and sc.name = 'quote_number' and st.usertype = sc.usertype and st.name = 'numeric' )
	alter table quote_detail modify quote_number integer not null
go

if not exists ( select 1 from dbo.systypes st,dbo.sysobjects so, dbo.syscolumns sc where so.name = 'quote_detail' and sc.id = so.id and sc.name = 'sequence' and st.usertype = sc.usertype and st.name = 'smallint' )
	alter table quote_detail modify sequence smallint not null
go
...
alter table quote_detail add primary key ( quote_number, sequence )
go
...
-------------------------
'
if not exists ( select 1 from dbo.sysobjects where name = 'report_library' )
begin
...
begin
	if ( select count(1) from syscolumns where tname = 'report_library' and in_primary_key = 'Y' ) > 0
		alter table report_library drop primary key
...
if not exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.name = 'shipper_detail' and sc.id = so.id and sc.name = 'part_name' and sc.length = 100 )
	alter table shipper_detail modify part_name varchar(100) null
go

if ( select count(1) from sys.sysindexes where tname = 'shipper_detail' ) > 1
	drop index order_no
go
...
begin
	...
	update shipper_detail set alternate_price = price
end
go

if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'shipper_detail' and sc.id = so.id and sc.name = 'release_date' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table shipper_detail modify release_date datetime
go

if exists ( select 1 from dbo.systypes st,dbo.syscolumns sc,dbo.sysobjects so where so.name = 'shipper_detail' and sc.id = so.id and sc.name = 'date_shipped' and st.usertype = sc.usertype and st.name = 'timestamp' )
	alter table shipper_detail modify date_shipped datetime
go
...
if exists ( select 1 from dbo.sysobjects where name = 'work_order' )
	alter table work_order rename work_order_temp
go
...
begin
	insert into work_order (work_order, tool, cycles_required, cycles_completed, 
	    machine_no, process_id, customer_part, setup_time, cycles_hour, 
	    standard_pack, runtime, employee, type, accum_run_time, cycle_unit, 
	    material_shortage, lot_control_activated, plant, order_no, destination, 
	    customer, note, due_date, sequence, cycle_time, start_date, start_time, end_date, end_time) select work_order, tool, convert(numeric(10),
...
if exists ( select 1 from dbo.sysobjects where name = 'workorder_header_history' )
	alter table workorder_header_history rename workorder_header_history_temp
go
...
--------------------
'
if exists (select 1 from dbo.sysobjects where id = Object_id ( 'm_in_release_plan' ) )
...
-------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id ( 'm_in_release_plan_exceptions' ))
...
-------------------
'
if exists (select 1 from sysobjects where id = Object_id ( 'm_in_customer_po' ))
...
------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id ( 'm_in_customer_po_exceptions' ) )
...
---------------------
'
if exists (select 1 from sysobjects where id = Object_id ( 'm_in_ship_schedule' ) )
...
--------------------------------
'
if exists (select 1 from sysobjects where id = object_id ( 'm_in_ship_schedule_exceptions' ) )
...
---------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id('serial_asn'))
...
-------------------------------
'
if exists (select 1 from dbo.sysobjects where name = 'requisition_security' ) and
   not exists (select 1 from dbo.sysobjects where name = 'requisition_sec_bkup')
	alter table requisition_security rename requisition_sec_bkup
go
...
if exists (select 1 from dbo.sysobjects where name = 'requisition_sec_bkup' )
begin
	...
	if exists
		(select	1 from dbo.sysobjects join dbo.syscolumns on dbo.sysobjects.id = dbo.syscolumns.id
...
-------------------------------------------------------
'
if exists ( select 1 from employee where  employee.operator_code not in 
...
-------------------------------------------------------
'
if exists (select 1 from dbo.sysobjects	where name = 'requisition_header' )
	alter table requisition_header rename requisition_header_bkup
go
...
if exists (select 1 from dbo.sysobjects	where name = 'requisition_header_bkup' )
begin
...
-------------------------------------------------------
'
if exists (select 1 from  dbo.sysobjects where name = 'requisition_detail' )
	alter table requisition_detail rename requisition_detail_bkup
go
...
if exists (select 1 from dbo.sysobjects where name = 'requisition_detail_bkup' )
begin
...
begin
	...
	CREATE  INDEX acct_indx ON requisition_account_project(account_number)
...
begin
	...
	CREATE  INDEX acct_index ON requisition_group_account(account_no)
end
go
...
----------------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id('mvw_effectivechangenotice') )
...
if exists (select 1 from dbo.sysobjects where id = object_id('mvw_eng_level') )
...
----------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id('cs_ship_history_vw'))
...
-------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id('cs_customers_vw'))
...
if exists (select 1 from dbo.sysobjects where name = 'msp_build_vendor_part_list' )
...
--------------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id('msp_build_bom_timeline'))
...
----------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id ('msp_build_rma_exp_objects') )
...
------------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id('msp_build_label_list') )
...
if exists (select 1 from dbo.sysobjects where id = object_id('msp_explode_part'))
...
create table #bom_info(
        ...
        bom_level                              int)
go
if exists (select 1 from dbo.sysobjects where id = object_id('msp_build_mps'))
...
-----------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id('msp_build_recv_grid'))
...
-- procedure:	msp_calc_shipper_weights
----------------------------------------
if exists (select 1 from dbo.sysobjects where id = object_id('msp_calc_shipper_weights'))
...
-------------------------------------------
'
IF Exists (SELECT 1 FROM dbo.sysobjects WHERE id = Object_id ( 'msp_calc_committed_dropship' ) )
...
-------------------------
'
if	exists	(select	1 from dbo.sysobjects where id = object_id ( 'msp_find_internal_part' ) )
...
-------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id ( 'msp_create_customer_po' ) )
...
------------------------------------------
'
IF Exists (SELECT 1 FROM dbo.sysobjects WHERE id = Object_id ( 'msp_calculate_std_quantity' ) )
...
----------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id('msp_check_downline'))
...
-----------------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id('msp_customer_price_matrix'))
...
--------------------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id('msp_customer_price_matrix_no'))
...
-------------------------------
'
if exists(select 1 from dbo.sysobjects where name='msp_fp_list_sub' and type = 'P')
...
--------------------------------
'
if exists(select 1 from dbo.sysobjects where name='msp_fp_list_main' and type = 'P')
...
-----------------------------------
'
IF Exists (SELECT 1 FROM dbo.sysobjects WHERE id = Object_id ( 'msp_generate_kanban' ) )
...
---------------------------------------
if exists (select 1 from dbo.sysobjects where id = object_id('msp_get_1050_compl_data'))
...
-------------------------------------
if exists (select 1 from dbo.sysobjects where id = object_id('msp_get_1050_iss_data'))
...
------------------------------
'
if exists (select 1 from dbo.sysobjects where id = 	object_id('msp_get_onhand') )
...
-------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id('msp_get_po_list') )
...
if exists (select 1 from dbo.sysobjects where id = object_id ( 'msp_reconcile_shipper' ) )
...
----------------------------
'
IF Exists (SELECT 1 FROM dbo.sysobjects WHERE id = object_id ( 'msp_reconcile_rma_shipper' ) )
...
if exists (select 1 from dbo.sysobjects where id = object_id  ( 'msp_reverse_rma_object' )  )
...
-----------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id('msp_router_treeview'))
...
if exists (select 1 from dbo.sysobjects	where id = object_id ( 'msp_sync_shipper_invoice' ) )
...
if exists (select 1 from dbo.sysobjects where id = object_id ( 'msp_sync_parm_shipper_invoice' ) )
...
---------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id ( 'msp_shipping_dock_objects_list' ) )
...
-----------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id('msp_super_cop'))
...
begin
	...
	set 	flag = 0
	from 	order_detail 
		join master_prod_sched mps on mps.origin = order_no and
...
------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id ( 'msp_transferinsertedrelease' ) )
...
-----------------------------------
'
IF Exists (SELECT 1 FROM sysobjects WHERE id = Object_id ( 'msp_unit_conversion' ) )
...
-----------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id('msp_unit_list'))
...
------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id('msp_update_part_qty_asgnd'))
...
if exists (( select 1 from dbo.sysobjects where	id = object_id ( 'edi_msp_shipout' ) ) )
...
--	8.	Loop through all releases for this part and suffix in due_date order.
	...
	while ( @@sqlstatus = 0 and @stdqty > 0 )
	begin -- (2aB)
...
if exists (select 1 from dbo.sysobjects where id = object_id ( 'msp_stage_object' ) )
...
if exists (select 1 from dbo.sysobjects where id = object_id ( 'msp_unstage_object' ) )
...
-----------------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id('msp_create_shipper_detail') )
...
--	insert row into shipper_detail table 
        ...
        select  @shipper,
                ...
                (       case part.class
                                when 'M' then part_mfg.gl_account_code
                                when 'P' then part_purchasing.gl_account_code 
                        end  ),
                ...
                #boxes_on_pallet.std_price 
        from    #boxes_on_pallet
                join part on #boxes_on_pallet.part = part.part
                join part_inventory on #boxes_on_pallet.part = part_inventory.part
                left outer join part_mfg on part_mfg.part = part.part
                left outer join part_purchasing on part_purchasing.part = part.part
	commit transaction	
...
----------------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id('msp_calc_part_cust_price') )
	drop procedure msp_calc_part_cust_price
GO
...
---------------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id('msp_productionpotential') )
...
----------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id('msp_calculateyield'))
...
---------------------------------------
'
if exists ( select 1 from dbo.sysobjects where name = 'msp_packlineobjectslist' and type = 'P')
...
-----------------------------------
'
if exists ( select 1 from dbo.sysobjects where name = 'msp_labelsfromorder' )
...
----------------------------
'
if exists ( select 1 from dbo.sysobjects where name = 'msp_getnotes' and type = 'P')
...
-------------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id('msp_get_hierarchy'))
...
if exists (select 1 from dbo.sysobjects where id = object_id('msp_update_po_qty_assigned'))
...
-----------------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id('msp_create_requisitionrel'))
...
---------------------------------
'
if exists(select 1 from dbo.sysobjects where name='mtr_gl_account')
	drop trigger mtr_gl_account
go

if exists(select 1 from dbo.sysobjects where name='mtr_audit_trail_i')
...
print'
---------------------------------------------------
-- trigger:	mtr_bill_of_lading_u (SQL Anywhere)
---------------------------------------------------
'
...
-------------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id('mt_bill_of_material_ec_i'))
	drop trigger mt_bill_of_material_ec_i
GO
if exists (select 1 from dbo.sysobjects where id = object_id('mtr_bill_of_material_ec_i'))
...
-------------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id('mt_bill_of_material_ec_d'))
	drop trigger mt_bill_of_material_ec_d
GO
if exists (select 1 from dbo.sysobjects where id = object_id('mtr_bill_of_material_ec_d'))
...
-------------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id('mt_bill_of_material_ec_u'))
	drop trigger mt_bill_of_material_ec_u
GO
if exists (select 1 from dbo.sysobjects where id = object_id('mtr_bill_of_material_ec_u'))
...
print'
--------------------------------------------------
-- TRIGGER:	mtr_currency_conversion_u (sqlany)
--------------------------------------------------
'
if exists ( select 1 from dbo.sysobjects where id = object_id ( 'mtr_currency_conversion_u' ) )
...
print'
--------------------------------------------------
-- TRIGGER:	mtr_currency_conversion_i (sqlany)
--------------------------------------------------
'
if exists ( select 1 from dbo.sysobjects where id = object_id ( 'mtr_currency_conversion_i' ) )
...
--------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id ( 'mtr_parameters_u' ) )
...
------------------------------
'
if exists ( select 1 from dbo.sysobjects where id = object_id('mt_part_machine_i'))
	drop trigger mt_part_machine_i
go
if exists ( select 1 from dbo.sysobjects where id = object_id('mtr_part_machine_i'))
	drop trigger mtr_part_machine_i
go
...
------------------------------
'
if exists ( select 1 from dbo.sysobjects where id = object_id('mt_part_machine_u'))
	drop trigger mt_part_machine_u
go
if exists ( select 1 from dbo.sysobjects where id = object_id('mtr_part_machine_u'))
	drop trigger mtr_part_machine_u
go
...
------------------------------
'
if exists ( select 1 from dbo.sysobjects where id = object_id('mt_part_machine_d'))
	drop trigger mt_part_machine_d
go
if exists ( select 1 from dbo.sysobjects where id = object_id('mtr_part_machine_d'))
	drop trigger mtr_part_machine_d
go
...
---------------------------------------------
'
if exists ( select 1 from dbo.sysobjects where name = 'mtr_part_customer_price_matrix_iu'  )
	drop trigger mtr_part_customer_price_matrix_iu
go
...
/*
				...
				if (update(received) or update(quantity)) and (@received_new-@received) <> 0
				begin
					insert into cdipohistory 
						(po_number, vendor, part, uom, date_due, type, last_recvd_date, 
						last_recvd_amount, quantity, received, balance,	price, row_id, 
...
---------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id('mtr_po_header_u'))
...
---------------------------------
'
if exists ( select 1 from dbo.sysobjects where id = object_id('mt_activity_router_d'))
	drop trigger mt_activity_router_d
go
if exists ( select 1 from dbo.sysobjects where id = object_id('mtr_activity_router_d'))
...
----------------------------
'
if exists ( select 1 from dbo.sysobjects where id = object_id('mt_object_weight_i'))
	drop trigger mt_object_weight_i
go
if exists ( select 1 from dbo.sysobjects where id = object_id('mtr_object_weight_i'))
	drop trigger mtr_object_weight_i
go
if exists ( select 1 from dbo.sysobjects where id = object_id('mtr_object_i'))
...
if exists (select 1 from dbo.sysobjects where id = object_id('mtr_employee_i') )
...
if exists (select 1 from dbo.sysobjects where id = object_id('mtr_employee_u') )
...
if exists (select 1 from dbo.sysobjects where id = object_id('mtr_employee_d') )
...
-------------------------------------------------------
'
if exists (select 1 from dbo.sysobjects where id = object_id('msp_form_release'))
...
if exists (select 1 from dbo.sysobjects where id = object_id('msp_form_ecl'))
...
---------------------------- 
'
if not exists ( select 1 from dbo.sysobjects so, dbo.syscolumns sc where so.id = sc.id and so.name = 'parameters' and sc.name = 'audit_deletion' )
begin
	alter table parameters add (audit_deletion char(1) null)
