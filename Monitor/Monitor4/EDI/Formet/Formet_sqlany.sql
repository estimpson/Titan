...
if exists (select * from sysobjects where id = object_id('edi_830_releases'))
        drop table edi_830_releases
        
GO

CREATE TABLE edi_830_releases (
...
if exists (select * from sysobjects where id = object_id('edi_830_oh_data'))
        drop table edi_830_oh_data
        
GO

CREATE TABLE edi_830_oh_data (
        release_no		varchar	(30) NULL,
        supplier		varchar	(30) NULL,
        ship_to 		varchar (30) NULL,
        customer_part 		varchar (30) NULL,
...
if exists (select * from sysobjects where id = object_id('edi_830_AuTH'))
        drop table edi_830_AuTH
        
GO

CREATE TABLE edi_830_AuTH (
        release_no		varchar	(30) NULL,
        supplier		varchar	(30) NULL,
        ship_to 		varchar (30) NULL,
        customer_part 		varchar (30) NULL,
...
if exists (select * from sysobjects where id = object_id('edi_830_AuTH_history'))
        drop table edi_830_AuTH_history
        
GO

CREATE TABLE edi_830_AuTH_history (
        release_no		varchar	(30) NULL,
        supplier		varchar	(30) NULL,
...
if exists (
	select	*
	  from	sysobjects
	 where	id = object_id ( 'msp_process_in_release_plan_formet' ) )
	drop procedure	msp_process_in_release_plan_formet
go

create procedure msp_process_in_release_plan_formet
as
-------------------------------------------------------------------------------------
